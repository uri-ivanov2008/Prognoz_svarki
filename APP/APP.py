...
def set_params(IW, IF, VW, FP):
    ...
    model = keras.models.load_model(r"C:\Users\Lenurchik\Desktop\Итоговая работа\APP\models\model_1")
...
def app_calculation():
    ...
    return render_template("C:/Users/Lenurchik/Desktop/Итоговая работа/APP/templates/index.html", message = message) 
